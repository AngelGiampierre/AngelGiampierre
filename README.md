...
|---------|-------------|-------|
| [**Yago**](https://yavendio.com) | AI WhatsApp sales agent for e-commerce merchants | Python, LangGraph, FastAPI, Temporal |
| **yago-kb** | Knowledge base API with hybrid vector + BM25 search | FastAPI, Turbopuffer, OpenAI, React |
| [**olive**](https://github.com/YaVendio/olive) | Transform Python functions into remote tools for AI agents | Python, Temporal, TLS |
...
**AI/ML:** LangGraph, LangChain, OpenAI API, Anthropic API, YOLO11, TensorFlow, scikit-learn, FAISS, Turbopuffer, LangSmith

**Backend:** Python, FastAPI, Temporal, PostgreSQL, Redis, Docker

**Frontend:** TypeScript, Next.js, React, Tailwind CSS

**Cloud:** AWS, Azure, GCP, Vercel, Northflank

**Robotics:** ROS2, LabVIEW, OpenCV, NVIDIA Jetson, SolidWorks, 3D printing

## Beyond code

- **Yachay Wasi** (2020-present) -- Innovation & Quality lead at a volunteer-run nonprofit with presence in 11 regions of Peru. I automated critical processes (mentor matching, onboarding, certificates) that went from taking weeks to minutes.
- **Yanapay** (2018-present) -- Animal welfare volunteer in Calca, Cusco. Treasury management and community campaigns.
- **World Robot Olympiad** -- Represented Peru at the 12th WRO in Doha, Qatar.
- **Speedcubing** -- Active competitor, chasing sub-10 on 3x3.
- **Running** -- Three half marathons, PR 1:53.

## Let's connect

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/angelhuapayat/)
[![Email](https://img.shields.io/badge/Email-EA4335?style=flat&logo=gmail&logoColor=white)](mailto:angel.huapaya@utec.edu.pe)
